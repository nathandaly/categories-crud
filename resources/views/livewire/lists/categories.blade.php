<div x-data="Components.categories({ categories: {{ json_encode($categories) }} })">
        ...
        <div class="mt-5 bg-white shadow overflow-hidden sm:rounded-md">
            ...
            @forelse($categories as $index => $category)
                <li class="hover:bg-indigo-50 cursor-pointer">
                    <a class="flex-1" href="{{ route('category.show', $category) }}">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3 flex-1 md:flex md:justify-between">
                                    <p class="text-sm text-blue-700">
                                        No category data currently available.
                                    </p>
                                </div>
                            </div>
                        </div>
